...
class FactoryMachineSpec::FewestIndicatorLightButtonPressesTest < Minitest::Test
  def setup
  ...
  def test_one_button_press
    ...
    assert_equal 1, @spec.fewest_indicator_light_button_presses
  end
  ...
  def test_two_button_presses
    ...
    assert_equal 2, @spec.fewest_indicator_light_button_presses
  end
  ...
  def test_three_button_presses
    ...
    assert_equal 3, @spec.fewest_indicator_light_button_presses
  end
